...
const Feature = ({ featureID, title, subTitle, description, profileImage }) => {
  return (
    ...
    >
      <div className="md:w-[40.9vw] lg:w-[45vw] w-[80vw] xs:w-[85vw] sm:w-[70vw] mx-auto  bgGlow rounded-xl  sm:rounded-[1vw] overflow-hidden border-[2px] border-[#7f43ef57]">
        <img
          src={FeatureImg1}
          alt="feature Image..."
      ...
      <SectionTitleInfo
        className={` text-start overflow-hidden w-[80vw] xs:w-[85vw] sm:w-[70vw] md:w-[52vw]  sm:px-0 md:px-[1.5vw] lg:px-[4vw]  mx-auto md:py-0 py-5 ${
          featureID % 2 != 0 && "flex-row-reverse lg:ps-0"
        }`}
        subTitleClassName="w-full text-[1.7vw] sm:text-[1vw] md:text-[1.3vw] scale-y-[.7] font-semibold lg:py-[1.5vw] sm:tracking-[1.5px] md:tracking-[2px] "
