...
const NavBar = () => {
  ...
  return (
    <nav className=" w-[90%]  sticky top-4 z-[999] bg-gradient-to-r from-[#15091d] via-[#8043ef]  to-[#15091d] rounded-[18px] mx-auto px-[2vw] py-[2vw] sm:px-12 sm:py-[14px] mt-4 flex justify-between lg:justify-start gap-0 lg:gap-10 items-center ">
      <div>
        <Logo className="w-[20vw] sm:w-[160px] h-[5vw] sm:h-[28.16px]" />
      </div>
      <div className=" w-[80%] flex lg:justify-between justify-end relative">
        ...
        <GrMenu onClick={()=> {setToggle(!toggle)}} className="text-white text-[8vw] xs:text-[5vw] sm:text-[30px] cursor-pointer lg:hidden" />
