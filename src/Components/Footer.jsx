  ...
  return (
    <footer className="w-full h-fit text-white">
      <div className="sm:w-[90%] py-5 mt-10 customGradient-bg dark:bg-[#8043ef]  mx-auto rounded-t-3xl text-center border-t border-[#8043ef]">
        ...
        <p className=" text-[3.8vw] xs:text-[3.4vw] sm:leading-none leading-5 font-[200] sm:text-[2vw] md:text-[2.3vw] lg:text-[1.2vw] px-2 sm:px-[3vw] md:px-[10vw] lg:px-[15vw] ms:pb-5 pt-2">
          This site is not a part of the Facebook website or Facebook Inc.
          Additionally, This site is NOT endorsed by Facebook in any way.
          FACEBOOK is a trademark of FACEBOOK, Inc.
        </p>
        <p className=" text-[3vw] xs:text-[2.5vw] sm:text-[10px] md:text-[1.1vw] py-2">
