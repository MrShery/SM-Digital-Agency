...
const AccordionItem = ({ question, answer }) => {
  ...
  useEffect(() => {
    if (toggle) {
      ...
      container.current.style.height = "7vw";
  ...
  return (
    <div
      ...
      className="accordionTransition max-h-fit  md:max-h-fit sm:min-h-[6vw] min-h-[8vw] text-white  md:py-[1vw] h-[5vw] overflow-hidden cursor-pointer"
    >
