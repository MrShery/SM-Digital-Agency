...
const ResultsSection = () => {
  return (
    <section className="w-[87%] py-[5vw] md:my-8 customGradient-bg  mx-auto text-center border-t border-[#8340ff] rounded-[2.5vw] sm:rounded-[1.5vw] lg:mt-[8vw]  ">
      <div className="px-[10vw">
        <SectionTitleInfo
          ...
          peraClassName="px-[10vw]  lg:w-[55vw] py-[3vw] xs:px-[1vw] xs:py-[3vw] xs:text-[3vw] lg:text-[1.2vw] text-[#959586] "
          ...
          titleClassName="lg:px-[15vw] lg:pb-[1.1vw] lg:leading-[5vw] md:pb-5 lg:text-[4.8vw] font-semibold  sm:bg-[linear-gradient(#ffff_100%,#ffff_100%)]"
        />
      </div>
