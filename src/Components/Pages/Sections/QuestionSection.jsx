...
const QuestionSection = () => {
  return (
    ...
    <div className="my-5">
      ...
      <div className="mx-auto  w-[28.7vw] h-[8.6vw] md:w-[18.7vw] md:h-[5.6vw] flex justify-center items-center  rounded-[1.5vw] customGradient-bg2">
        <div className=" w-[28.4vw] h-[8.3vw] md:w-[18.3vw] md:h-[5.3vw] rounded-[1.5vw] bg-[#000] dark:bg-white">
          <img src={SmLogo} alt="" className="sm:px-6 px-3 md:px-10 py-1  md:py-4  w-[28.4vw] h-[7vw] md:w-[18.4vw] md:h-[5vw] dark:invert" />
        </div>
      </div>
